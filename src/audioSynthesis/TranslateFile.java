...
public class TranslateFile {
    ...
    public TranslateFile(String apiKey) {
        key = apiKey;
    }
 
    String translte(String text, String from, String to, String Construct) {
        ...
        try {
            ...
            if (element.isJsonObject()) {
                ...
                if (obj.get("error") == null) {
                    ...
                    translatedText=translatedText.replaceAll("&quot","\"");
